package com.lifeihong.cms.domain;
...
public class Article implements Serializable {
	...
	public String toString() {
		return "Article [id=" + id + ", title=" + title + ", picture=" + picture + ", channelId=" + channelId
				+ ", categoryId=" + categoryId + ", userId=" + userId + ", user=" + user + ", hits=" + hits + ", hot="
				+ hot + ", status=" + status + ", deleted=" + deleted + ", created=" + created + ", updated=" + updated
				+ ", content=" + content + ", contentType=" + contentType + ", keywords=" + keywords + ", origin="
				+ origin + "]";
	}
