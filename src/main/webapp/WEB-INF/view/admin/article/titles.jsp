	...
	<div class="container">
		...
		<ul class="list-unstyled">
			...
			<c:forEach items="${articles }" var="a">
				<li class="media"><a href="${pageContext.request.contextPath}/article/selectByAdmin?id=${a.id }"
					target="_blank"><img class="mr-3" src="/pic/${a.picture }"
						alt="no pic" width="100px" height="100px"> </a>
					<div class="media-body">
						<dl>
							<dt>
								<a href="${pageContext.request.contextPath}/article/selectByAdmin?id=${a.id }" target="_blank">${a.title}</a>
							</dt>
...
function query(){
var url="${pageContext.request.contextPath}/article/selectsByAdmin?status="+$("#status").val()+"&channelId="+$("#channel").val()+"&categoryId="+$("#category").val()
...
$(function(){
	...
	//为栏目下拉框填充内容
   $.get("${pageContext.request.contextPath}/channel/channels",function(list){
	   for(var i in list){
...
function getCategory(channelId){
	 ...
	 $.get("/channel/categorys",{cid:channelId},function(list){
		   for(var i in list){
