...
<body>
	...
	<script type="text/javascript">
	 ...
	 function update(uid,obj){
		...
		$.post("${pageContext.request.contextPath}/user/update",{id:uid,locked:locked},function(flag){
	  ...
	  function query(){
		 var url="${pageContext.request.contextPath}/user/selects?username="+$("#username").val()
		$("#content-wrapper").load(url)  ;
		  
	  }
	
	</script>
	<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/cms.js"></script>
</body>
</html>