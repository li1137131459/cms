...
<script>
	KindEditor.ready(function(K) {
		window.editor1 = K.create('textarea[name="content1"]', {
			cssPath : '${pageContext.request.contextPath}/resource/kindeditor/plugins/code/prettify.css',
			uploadJson : '${pageContext.request.contextPath}/resource/kindeditor/jsp/upload_json.jsp',
...
<body>
	...
	<form id="form1">
		...
		<div class="form-group">
			<label for="centent_type">文章类型</label>
			<select name="code" >
	...
	function publish(){
		...
		$.ajax({
			...
			contentType : false,
			url:"${pageContext.request.contextPath}/article/publish",
	...
	$(function(){
	   ...
	   $.get("${pageContext.request.contextPath}/channel/channels",function(list){
		...
		$("#channel").change(function(){
			...
			//获取当前的栏目ID
		  var cid =$(this).val();	
		  $.get("${pageContext.request.contextPath}/channel/categorys",{cid:cid},function(list){
			   for(var i in list){
