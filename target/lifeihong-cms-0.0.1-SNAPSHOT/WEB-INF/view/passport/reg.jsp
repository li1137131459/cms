		...
		<div class="row passport_bg">
			...
			<div class="col-md-6">
				<div class="passport_panel">
					...
					<form:form action="${pageContext.request.contextPath}/passport/reg" method="post" id="form1"
			...
			<div class="col-md-6">
				<div class="passport_r">
					<h3>最新加入的用户：</h3>
					<p align="center">
						<img src="${pageContext.request.contextPath}/resource/images/guest.jpg" alt="..."
							class="rounded-circle img-thumbnail" /> &nbsp;&nbsp;&nbsp;&nbsp;
						<img src="${pageContext.request.contextPath}/resource/images/guest1.jpg" alt="..."
							class="rounded-circle img-thumbnail" />
					</p>
				</div>
			</div>
